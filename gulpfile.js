...
exports.default = series(clean, resources, htmlBuild, styles, images, toWebp, svgSprites, fonts, watchFiles);
exports.build = series(isProd, clean, resources, htmlBuild, htmlMinify, styles, images, toWebp, fonts, svgSprites);
